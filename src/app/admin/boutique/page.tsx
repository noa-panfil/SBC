...
const sections = [
    { href: "/admin/boutique/produits", icon: "fas fa-store", title: "Construire la boutique", text: "Collections, produits, couleurs, tailles, photos et prix", color: "from-emerald-500 to-green-700" },
