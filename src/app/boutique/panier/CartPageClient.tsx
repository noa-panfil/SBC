                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex items-start justify-between gap-3">
                                                        <div>
                                                            ...
                                                            {line.personalizations.length > 0 && <div className="mt-1 space-y-0.5 text-sm font-semibold text-sbc-dark">{line.personalizations.map((personalization) => <p key={personalization.type}>{personalization.type === "text" ? "Texte" : "Numéro"} « {personalization.value} » · {personalization.placement === "front" ? "Devant" : "Dos"}</p>)}<p className="text-xs text-gray-500">{line.personalizationPriceCents === 0 ? "Personnalisation gratuite" : `Supplément : +${formatEuros(line.personalizationPriceCents)}`}</p></div>}
